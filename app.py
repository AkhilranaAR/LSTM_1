...
def forecast():
    ...
    BASE_IMAGE_PATH = os.environ.get(
        'BASE_IMAGE_PATH', 'https://storage.googleapis.com/lstm-microservice-setup-1/')
    ...
    MODEL_LOSS_IMAGE_NAME = "model_loss_" + type +"_" + cat +"_"+ repo_name + ".png"
    MODEL_LOSS_URL = BASE_IMAGE_PATH + MODEL_LOSS_IMAGE_NAME

    LSTM_GENERATED_IMAGE_NAME = "lstm_generated_data_" + type +"_" + cat +"_"+ repo_name + ".png"
    LSTM_GENERATED_URL = BASE_IMAGE_PATH + LSTM_GENERATED_IMAGE_NAME

    ALL_ISSUES_DATA_IMAGE_NAME = "all_issues_data_" + type + "_"+ cat +"_"+ repo_name + ".png"
    ...
    BUCKET_NAME = os.environ.get(
        'BUCKET_NAME', 'lstm-microservice-setup-1')
    ...
    axs.legend()
    axs.set_title('LSTM Generated Data For ' + type + ' ' + cat)
